/// cl_Reflector_create(i_grid_x, i_grid_y, f_orig_x, f_orig_y)
...
var i_spr_w = sprite_get_width(spr_cl_Reflector);
var i_spr_h = sprite_get_height(spr_cl_Reflector);

var reflector_new = instance_create(f_orig_x + i_grid_x * i_spr_w, 
                            f_orig_y + i_grid_y * i_spr_h, cl_Reflector);
