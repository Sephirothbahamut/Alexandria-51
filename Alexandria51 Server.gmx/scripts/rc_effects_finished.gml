/// rc_effects_finished(client)
var client = verify(argument0, var_t.object_t, false, Client);
/// ______________________________________
//This client/character has finished running effects on the client side
var character = rc_char_from_pid(client.u_pid);

character.b_done = true;

show_debug_message("Client " + string(client.u_pid) + " has finished running effects");
...
if(b_all_done)
    ...
    show_debug_message("All clients have finished running effects");
