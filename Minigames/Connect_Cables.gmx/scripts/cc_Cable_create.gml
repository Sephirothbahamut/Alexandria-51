/// cc__Cable_create(i_grid_x, i_grid_y, f_orig_x, f_orig_y, i_cable, i_angle)
...
var i_tile_w = sprite_get_width(spr_cc_Cables);
var i_tile_h = sprite_get_height(spr_cc_Cables);

var cable_new = instance_create(f_orig_x + i_grid_x * i_tile_w, 
                            f_orig_y + i_grid_y * i_tile_h, cc_Cable);

cable_new.i_grid_x = i_grid_x;
cable_new.i_grid_y = i_grid_y;

cc_Cable_set(cable_new, i_cable, i_angle);
