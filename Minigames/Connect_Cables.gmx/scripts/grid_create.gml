/// grid_create(i_grid_w, i_grid_h, i_n_cables)
var i_grid_w = argument0; var i_grid_h = argument1; 
var i_n_cables = argument2;

var grid_tile = ds_grid_create(i_grid_w, i_grid_h);
var f_orig_x = (room_width / 2) - ((i_grid_w * sprite_get_width(spr_Cables)) / 2);
var f_orig_y = (room_height / 2) - ((i_grid_h * sprite_get_height(spr_Cables)) / 2);
