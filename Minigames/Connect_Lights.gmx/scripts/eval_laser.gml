...
source.f_hit_x = Connect_Lights_Controller.f_orig_x + (source.coords_laser_dest[X] * sprite_get_width(spr_Floor));
source.f_hit_y = Connect_Lights_Controller.f_orig_y + (source.coords_laser_dest[Y] * sprite_get_height(spr_Floor));
