/// next_coords_new(grid_tile, i_grid_w, i_grid_h, coords_start, i_coords_safety, i_min_len, i_max_len, dir4_last);
var grid_tile = argument0;      var i_grid_w = argument1; var i_grid_h = argument2;
var coords_start = argument3;   var i_coords_safety = argument4;
var i_min_len = argument5;      var i_max_len = argument6;
var dir4_last = argument7;
...
else
{
    ...
    while(ds_list_size(list_dir) > 0)
    {
        ...
        var i_next_coords_safety = check_path_coords(grid_tile, i_grid_w, i_grid_h, coords_new);
        
        if(i_next_coords_safety == coords_safety.safe)
        {
            var arr_coord_path = next_coords_new(grid_tile, i_grid_w, i_grid_h, coords_new, i_next_coords_safety, i_min_len - 1, i_max_len - 1, dir4);
